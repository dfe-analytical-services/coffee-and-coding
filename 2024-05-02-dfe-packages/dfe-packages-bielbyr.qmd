...
- And again, some of the functionality that's currently available:
  - `cookie_banner_ui()` / `cookie_banner_server()` / `dfe_cookie_script()`
...
And finally, this slide pack is available on the Coffee and Coding GitHub site:
  - [https://github.com/dfe-analytical-services/coffee-and-coding](https://github.com/dfe-analytical-services/coffee-and-coding)
