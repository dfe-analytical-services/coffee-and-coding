...
2017/06/07 | Parliamentary Questions (PQ) tools | [Tamsin Forbes](https://github.com/tamsinforbes) | Tamsin presents her Data Science Accelerator project to explore ways of automating Parliamentary Question (PQ) allocation in R; implementing a bit of natural language processing and the random forest algorithm. We'll also look at a tool produced by the MoJ.
2017/05/24 | A Gallery of VBA | [Chris Thom](https://github.com/cwthom) | Chris Thom will demonstrate how to use VBA for a variety of tasks, including automated reporting and interactivity.
